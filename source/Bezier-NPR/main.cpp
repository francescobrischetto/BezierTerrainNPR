/*
Extension of NPR Technique called "Suggestive Contours" to Terrain Generated by stitching Bezier Surfaces and Tessellated in Real-time
author: Francesco Brischetto mat. 958022
Thesis Titled: Applicazioni di Tecniche di Rendering non Fotorealistico in tempo reale a 
scenari e modelli 3D definiti in modo parametrico - a.a. 2021/2022
...
int main()
{
  ...
  // we create the application's window
    ...
    /////////////////// ICON SETUP ///////////////////////
    GLFWimage images[1]; 
    images[0].pixels = stbi_load("Textures/Icon/icon.png", &images[0].width, &images[0].height, 0, 4); //rgba channels 
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // All UI Logic and Buttons Functionalities HERE
        ...
        case 2:
            ...
            ImGui::SameLine();
            if( ImGui::Button( "Load Shuttle" ) )
            {
                enableContours = false;
                enableSuggestiveContours = false;
                showingTerrain = false;
                camera.Position = glm::vec3(0,350,770);
                // Loading shuttle from disk (expressed with bezier surfaces)
                terrainModel = TerrainModel("../../models/shuttle.bez");
                
            }
            if (ImGui::IsItemHovered())
                ImGui::SetTooltip("Load Shuttle model expressed with bezier surfaces.");
            ImGui::NewLine();
            ImGui::Separator();
            break;
        case 3:
        ...
        case 4:
            ...
            ImGui::PopStyleColor();
            ImGui::NewLine();
            ImGui::Text( "NOTICE: You can use WASD and up/down arrow key to move camera." );
            ImGui::NewLine();
...
//////////////////////////////////////////
// If one of the WASD + UP AND DOWN keys is pressed, the camera is moved accordingly (the code is in utils/camera.h)
void apply_camera_movements()
{
    if(keys[GLFW_KEY_W])
...
//Styles buttons are just predefined set of values for all our variables
void ReddishStyle(){
